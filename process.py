...
data_dir = Path("E:/val2017")  # Thư mục ảnh gốc
annotation_file = "E:/instances_val2017.json"  # File annotation

# Thư mục để lưu ảnh sau khi xử lý
output_dir = Path("E:/coco_dataset/output")  # Thư mục chứa ảnh đầu ra
